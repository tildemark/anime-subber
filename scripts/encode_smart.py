...
def encode_file(input_vid, output_vid, settings):
...
if len(files) > 1:
    ...
    print(f"{'='*60}\n")
    print("Using default settings: source resolution, Preset 6, CRF 30\n")
    
    default_settings = {"res": "source", "p": "6", "crf": "30"}
    ...
    for i, input_file in enumerate(files, 1):
        ...
        encode_file(input_file, output_file, default_settings)
        print(f"✅ Complete\n")
    ...
    h1, s1 = estimate(input_vid, "source", 6, 30, duration)
    h2, s2 = estimate(input_vid, "source", 8, 36, duration)
    h3, s3 = estimate(input_vid, "720", 8, 32, duration)
    h4, s4 = estimate(input_vid, "720", 10, 40, duration)
    ...
    if choice in settings:
        ...
        encode_file(input_vid, output_vid, c)
